/**
 * @Author: fuqi
 * @Date:   2018-01-19T12:12:02+08:00
 * @Email:  29984051@qq.com
 * @Project: mmall
 * @Filename: uslider.js
 * @Last modified by:   fuqi
 * @Last modified time: 2018-02-20T11:36:05+08:00
 * @License: 123
 */
...
(function(t, s) {
    ...
    var i = function() {
        ...
        this.setup = function() {
            if (this.el.css({overflow: "hidden", width: i.max[0], height: this.items.first().outerHeight()}), this.ul.css({
